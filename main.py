...
def detect_edge(image): 
    ...
    return G1
# -------------------SOURCE-IMAGE---------------------------------
path    = 'E:\Github\Machine-learning-for-counting-blood-cells\cell_counter-Develope\crop.jpg'
img_rgb = cv.imread(path) 
img_rgb = cv.resize(img_rgb, (550, 550), interpolation=cv.INTER_AREA)
...
rows = gray.shape[0] 
circles = cv.HoughCircles(gray, cv.HOUGH_GRADIENT, 1, rows / 20, param1=200, param2=1, minRadius=0, maxRadius=0) 
